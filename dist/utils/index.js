...
export { JSONerrors, maxSizeValidation, minSizeValidation, setStandarError, required, requiredWithoutSubmit, number, pattern, text, password, confirmPassword, hasRequiredValidation, hasInvalidFieldsValidation };